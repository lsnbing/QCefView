#ifndef QCEFQMLVIEW_H
#define QCEFQMLVIEW_H
#pragma once
...
/// </summary>
class QCEFVIEW_EXPORT QCefQMLView : public QQuickPaintedItem
{
  Q_OBJECT
  Q_DECLARE_PRIVATE(QCefQMLView)
  //  Q_DISABLE_COPY(QCefView)
  QScopedPointer<QCefQMLViewPrivate> d_ptr;
...
public:
  ...
  QCefQMLView(const QString url, const QCefSetting* setting, QQuickItem* parent = 0);

  /// <summary>
  /// Constructs a QCefView instance
  /// </summary>
  /// <param name="parent">The parent</param>
  QCefQMLView(QQuickItem* parent = 0);
